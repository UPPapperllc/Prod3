...
$( window ).on( "load", function() {
	  var url = 'https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origins=49854&destinations=<?php echo $cs;?>&key=AIzaSyAqIVNLi2wrYIjx71kFYw_uN5LPiVqtyUA';
      var c=0;
      $.ajax({
          async: false,
          type: "GET",
          ...
          success: function (result) {
             ...
             var m = Math.round(result.rows[0].elements[0].distance.value / 1609.34);
            console.log(v, m);
            winc = 'ST' + c;
           chgurl  = "setrailTransitTime.php?CUST=<?php echo $cust;?>&TH=" + v[0] + "&TM=" + v[1] + "&TS=" + v[2] + "&MILES=" + m + "&ZIP=<?php echo $zip;?>";   
